...
class AppTheme {
  ...
  // Educational Gaming Color Palette - Energetic Learning Spectrum
  static const Color primaryLight = Color(0xFFFF7829); // Energizing orange
  static const Color primaryVariantLight = Color(0xFFE65100); // Darker orange
  static const Color secondaryLight = Color(0xFF2196F3); // Supporting blue
  static const Color secondaryVariantLight = Color(0xFF1976D2); // Darker blue
  static const Color successLight =
      Color(0xFF4CAF50); // Positive feedback green
  static const Color warningLight = Color(0xFFFF9800); // Gentle alert orange
  static const Color errorLight = Color(0xFFF44336); // Clear error red
  static const Color accentLight =
      Color(0xFFE91E63); // Special achievement pink
  static const Color backgroundLight =
      Color(0xFFFAFAFA); // Soft neutral background
  static const Color surfaceLight = Color(0xFFFFFFFF); // Clean content areas
  ...
  static const Color primaryDark =
      Color(0xFFFF8A50); // Lighter orange for dark mode
  static const Color primaryVariantDark = Color(0xFFFF7043); // Orange variant
  static const Color secondaryDark = Color(0xFF42A5F5); // Lighter blue
  static const Color secondaryVariantDark = Color(0xFF1E88E5); // Blue variant
  static const Color successDark = Color(0xFF66BB6A); // Success green
  static const Color warningDark = Color(0xFFFFB74D); // Warning orange
  static const Color errorDark = Color(0xFFEF5350); // Error red
  static const Color accentDark = Color(0xFFEC407A); // Accent pink
  static const Color backgroundDark = Color(0xFF121212); // Dark background
  static const Color surfaceDark = Color(0xFF1E1E1E); // Dark surface
  static const Color textPrimaryDark = Color(0xFFFFFFFF); // Light text
  static const Color textSecondaryDark =
      Color(0xFFB0BEC5); // Secondary light text
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    // Bottom navigation optimized for educational app
    ...
    // Floating action button for achievement highlights
    ...
    // Input decoration for forms and quizzes
    ...
    // Interactive elements for gamification
    ...
    // Tab bar for subject navigation
